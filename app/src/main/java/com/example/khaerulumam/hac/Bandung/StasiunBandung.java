...
public class MuseumBahari extends AppCompatActivity {

    private Toolbar mToolbar;
    private ViewPager mViewPager;
    private SectionBahari mSectionsPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Museum Bahari");
        ...
        mSectionsPagerAdapter = new SectionBahari(getSupportFragmentManager());
